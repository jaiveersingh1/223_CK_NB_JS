...
public class ApplicantActivity extends AppCompatActivity
    ...
    final String BE_APP_ID = "A714C78D-13EB-697C-FF81-8B69DA5C9F00";
    final String BE_ANDROID_API_KEY = "6D8EC84E-91C2-7A54-FF72-D63869B38000";

    private String MY_EMAIL_ADDRESS = "jsboygenius@gmail.com";
    public static String EMAIL_PREF = "bobkey";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user.setEmail( "jsboygenius@gmail.com" );
        ...
        Backendless.UserService.register(user, new AsyncCallback<BackendlessUser>(){
            ...
            public void handleFault(BackendlessFault backendlessFault) {
                Log.e( "Backendless reg err", backendlessFault.getMessage());
            }
        });
/*
